...
<template>
    <div class="scroll-smooth font-open max-h-screen">
        <div class="sticky top-0 z-20 bg-ivory">
            ...
            <div class="bg-ivory container p-4">
              <h1 class="capitalize font-extrabold text-2xl md:text-3xl lg:text-5xl text-black/80">our team memebers</h1>
              <div class="py-6 grid md:grid-cols-2 gap-16 justify-center mx-auto px-6 mg:px-12 lg:px-16">
