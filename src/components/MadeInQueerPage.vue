...
<template>
    <div class="bg-ivory max-h-full">
        <div class="snap-y snap-mandatory h-screen overflow-scroll">
            ...
            <!-- Banner -->
            <section id="page_banner" class="scroll-mt-28 snap-start h-screen min-h-screen w-full bg-cover bg-top banner2-url overflow-hidden z-20">
            ...
            <div v-for="(artist,index) in madeInQueerArray" :key="index" class="scroll-mt-28 snap-start pb-20">
                <!-- Quote of the Topic -->
