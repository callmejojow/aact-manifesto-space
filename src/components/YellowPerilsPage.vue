...
<template>
    <div class="scroll-smooth font-open">
        <div class="snap-y snap-mandatory">
            ...
            <!-- Banner -->
            <section id="page_banner" class="snap-start snap-always mb-4 lg:mb-12 h-screen w-full bg-cover banner3-url overflow-hidden z-20">
            ...
            <div v-for="(artist,index) in yellowPerilsArray" :key="artist" class="snap-start snap-always">
                <!-- Quote of the Topic -->
