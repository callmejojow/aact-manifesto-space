...
<template>
    <div class="font-open">
        <div class="sticky top-0 z-20 bg-ivory">
            <div class="flex justify-start lg:justify-center items-center py-4 px-4 md:px-0 border-b border-stone-200/80">
                <a href="/">
        ...
        <!-- Banner -->
        <kinesis-container>
            <section class="h-screen w-full bg-cover banner3-url">
        ...
        <section id="about" class="pt-36 relative h-screen w-full lg:h-full p-20 md:p-14 sm:p-10 p-6 tracking-wide leading-6 bg-ivory/50">
        ...
        <div v-for="(artist,index) in yellowPerilsArray" :key="artist">
            ...
            <section :id="`artist_${index}`" class="bg-bitten h-screen w-full h-80 lg:h-[48rem] w-screen bg-cover bg-scroll" :style="artist.quote_bg_url ? { backgroundImage: 'url(' + artist.quote_bg_url + ')' } : {}">
                <div class="w-full h-full flex flex-col items-center justify-center px-20 md:px-14 sm:px-10 px-6 bg-black/70" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-easing="ease-in-out">
                    <p class="font-thin tracking-wider max-w-4xl text-lg md:text-xl lg:text-2xl xl:text-3xl text-ivory/90" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-easing="ease-in-out" data-aos-delay="600">
                        {{artist.quote}}
                    </p>
                    <p class="mt-10 z-20 text-ivory/90 font-semibold text-xl md:text-2xl lg:text-3xl text-ivory text-center" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-easing="ease-in-out" data-aos-delay="1000">
                        {{artist.artist_name}}
                    </p>
                </div>
            </section>
            <!-- Art pieces of a certain artist with his/her introduction -->
            <div class="w-full tracking-wide leading-6 bg-ivory/50">
                        ...
                        <div class="lg:w-3/4">
                            ...
                            <p class="lg:text-justify">{{artist.description}}
                                <span v-if=" artist.format == 'mixed'">
                                    <a href="https://www.youtube.com/watch?v=t9qG14MSVPs" target="_blank" class="underline text-black hover:text-stone-900/70">See Video Here</a>
                                </span>
                            </p>
                        </div>
                ...
                <div v-if="artist.format == 'text'" class="relative h-full bg-black text-ivory lg:flex lg:justify-between lg:items-start gap-4 md:gap-12 lg:gap-24 p-4 md:p-8 lg:p-12">
