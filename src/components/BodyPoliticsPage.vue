    ...
    <div class="bg-ivory">
        <div class="snap-y snap-mandatory h-screen overflow-scroll">
            <div class="sticky z-30 top-0 bg-ivory h-26 lg:h-28 pt-4 md:pt-6 lg:pt-4 px-6 md:px-12 lg:px-0">
                ...
                <div class="pt-3.5 hidden lg:flex lg:justify-start lg:items-center lg:px-12 lg:border-b lg:border-stone-400/50 pb-6 lg:pb-3 text-sm">
            ...
            <!-- Banner -->
            <section id="page_banner" class="scroll-mt-28 snap-start h-screen min-h-screen w-full bg-cover bg-top banner1-url overflow-hidden z-20">
            ...
            <div v-for="(artist,index) in bodyPoliticsArray" :key="index" class="scroll-mt-28 snap-start pb-20">
                <!-- Quote of the Topic -->
