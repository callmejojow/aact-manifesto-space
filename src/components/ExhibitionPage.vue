    ...
    <main class="min-h-screen font-open">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 justify-center lg:items-center relative overflow-hidden min-h-screen max-h-full pt-0 md:portrait:pt-0 md:landscape:pt-4 lg:pt-4 bg-ivory mx-auto">
            ...
            <div id="sections" class="pb-4 mb:portrait:pb-4 mb:landscape:pb-0 mb:landscape:pt-0 mb:landscape:mt-0 mb:portrait:pt-36 mb:portrait:-mt-36 lg:pb-0 pt-36 -mt-36 lg:pt-0 lg:mt-0 col-span-1 flex flex-col lg:flex-row justify-end min-w-screen h-[calc(100vh-36px)] lg:min-h-screen">
                <div class="h-1/3 md:portrait:h-1/3 md:landscape:h-screen md:landscape:w-1/3 lg:h-screen lg:w-1/3 bg-cover group bg-url-1">
                    <a href="/exhibitions/made_in_queer">
                        <div class="w-full h-full flex justify-center items-center backdrop-brightness-50 group-hover:backdrop-brightness-100 md:transition-all md:ease-in md:ease-out md:duration-300">
                            <p class="text-ivory text-4xl lg:text-2xl text-center font-thin md:landscape:transition-all md:landscape:ease-in md:landscape:ease-out md:landscape:duration-300 md:landscape:group-hover:opacity-100 md:landscape:opacity-0 lg:transition-all lg:ease-in lg:ease-out lg:duration-300 lg:group-hover:opacity-100 lg:opacity-0 opacity-100">MADE IN <span class="inline md:portrait:inline md:landscape:block lg:block">QUEER</span></p>
                        </div>
                    </a>
                </div>
                <div class="h-1/3 md:portrait:h-1/3 md:landscape:h-screen md:landscape:w-1/3 lg:h-screen lg:w-1/3 bg-cover group bg-url-2">
                    <a href="/exhibitions/body_politics">
                        <div class="w-full h-full flex justify-center items-center backdrop-brightness-50 group-hover:backdrop-brightness-100 md:transition-all md:ease-in md:ease-out md:duration-300">
                            <p class="text-ivory text-4xl lg:text-2xl text-center font-thin md:landscape:transition-all md:landscape:ease-in md:landscape:ease-out md:landscape:duration-300 md:landscape:group-hover:opacity-100 md:landscape:opacity-0 lg:transition-all lg:ease-in lg:ease-out lg:duration-300 lg:group-hover:opacity-100 lg:opacity-0 opacity-100">BODY <span class="inline md:portrait:inline md:landscape:block lg:block">POLITICS</span></p>
                        </div>
                    </a>
                </div>
                <div class="h-1/3 md:portrait:h-1/3 md:landscape:h-screen md:landscape:w-1/3 lg:h-screen lg:w-1/3 bg-cover group bg-url-3">
                    <a href="/exhibitions/yellow_perils">
                        <div class="w-full h-full flex justify-center items-center backdrop-brightness-50 group-hover:backdrop-brightness-100 md:transition-all md:ease-in md:ease-out md:duration-300">
                            <p class="text-ivory text-4xl lg:text-2xl text-center font-thin md:landscape:transition-all md:landscape:ease-in md:landscape:ease-out md:landscape:duration-300 md:landscape:group-hover:opacity-100 md:landscape:opacity-0 lg:transition-all lg:ease-in lg:ease-out lg:duration-300 lg:group-hover:opacity-100 lg:opacity-0 opacity-100">YELLOW <span class="inline md:portrait:inline md:landscape:block lg:block">PERILS</span></p>
                        </div>
                    </a>
                </div>
            </div>
