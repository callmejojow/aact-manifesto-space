            ...
            <div id="sections" class="pb-4 lg:pb-0 pt-36 -mt-36 lg:pt-0 lg:mt-0 col-span-1 flex flex-col lg:flex-row justify-end min-w-screen h-[calc(100vh-36px)] lg:min-h-screen">
                <div class="h-1/3 lg:h-screen lg:w-1/3 lg:h-screen bg-cover group bg-url-1">
                    <a href="/exhibitions/made_in_queer">
                        <div class="w-full h-full flex justify-center items-center backdrop-brightness-50 group-hover:backdrop-brightness-100 md:transition-all md:ease-in md:ease-out md:duration-300">
                            <p class="text-ivory text-4xl lg:text-2xl text-center font-thin md:transition-all md:ease-in md:ease-out md:duration-300 md:group-hover:opacity-100 md:opacity-0 opacity-100">MADE IN <span class="inline md:block">QUEER</span></p>
                        </div>
                    </a>
                </div>
                <div class="h-1/3 lg:h-screen lg:w-1/3 lg:h-screen bg-cover group bg-url-2">
                    <a href="/exhibitions/body_politics">
                        <div class="w-full h-full flex justify-center items-center backdrop-brightness-50 group-hover:backdrop-brightness-100 md:transition-all md:ease-in md:ease-out md:duration-300">
                            <p class="text-ivory text-4xl lg:text-2xl text-center font-thin md:transition-all md:ease-in md:ease-out md:duration-300 md:group-hover:opacity-100 md:opacity-0 opacity-100">BODY <span class="inline md:block">POLITICS</span></p>
                        </div>
                    </a>
                </div>
                <div class="h-1/3 lg:h-screen lg:w-1/3 lg:h-screen bg-cover group bg-url-3">
                    <a href="/exhibitions/yellow_perils">
                        <div class="w-full h-full flex justify-center items-center backdrop-brightness-50 group-hover:backdrop-brightness-100 md:transition-all md:ease-in md:ease-out md:duration-300">
                            <p class="text-ivory text-4xl lg:text-2xl text-center font-thin md:transition-all md:ease-in md:ease-out md:duration-300 md:group-hover:opacity-100 md:opacity-0 opacity-100">YELLOW <span class="inline md:block">PERILS</span></p>
                        </div>
                    </a>
                </div>
            </div>
